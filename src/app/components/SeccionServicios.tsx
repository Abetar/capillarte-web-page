...
const servicios = [
    {
        ...
        icon: <MonitorSmartphone className="w-10 h-10 text-teal-600 mb-4" />,
    },
    {
    ...
    },
    {
        ...
        icon: <Droplets className="w-10 h-10 text-teal-600 mb-4" />,
    },
    {
    ...
    },
    {
        ...
        icon: <UserCircle className="w-10 h-10 text-teal-600 mb-4" />,
    },
]
...
export default function SeccionServicios() {
    ...
    return (
        <section className="bg-teal-100 py-20 px-6 md:px-10 lg:px-16 xl:px-24 text-center" ref={ref}>
            <motion.h3
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {servicios.map((servicio, index) => (
                    <motion.div
                        key={index}
                        className="bg-white rounded-xl p-6 flex flex-col items-center justify-between shadow hover:shadow-md transition text-center h-full"
